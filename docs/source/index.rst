...
the MAPPINGS code, support the propagation of observational errors, auto-detect wraps in the diagnostics grids, and more.
...
.. note::
   ...
   You can track the latest changes in the code in the :ref:`changelog` or on the dedicated `Github repository <https://github.com/fpavogt/pyqz>`_.
